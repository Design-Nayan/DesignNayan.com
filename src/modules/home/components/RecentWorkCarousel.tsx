...
import { recentProjects, ProjectItem } from "../data/home.data";
...
export function RecentWorkCarousel() {
  ...
  const handleScroll = () => {
    if (scrollRef.current) {
      ...
      setActiveIndex(Math.min(index, recentProjects.length));
    }
  };
  ...
  return (
    <section id="portfolio" className="py-14 sm:py-20 lg:py-24 px-4 sm:px-6 bg-white select-none">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Project Cards Horizontal Scroll: Clicking opens Project Details Modal */}
        <div
          ref={scrollRef}
        ...
        >
          ...
          {/* End-of-Scroll "View More" Card: Routes directly to /portfolio */}
          <Link
            href="/portfolio"
        ...
        <div className="flex 2xl:hidden items-center justify-center gap-1.5 pt-3 sm:pt-4">
          {[...recentProjects, { id: "view-more" }].map((_, idx) => (
            <button
              key={idx}
              onClick={() => {
                if (scrollRef.current) {
